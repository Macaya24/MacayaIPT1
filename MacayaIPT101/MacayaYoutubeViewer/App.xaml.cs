...
using MacayaIPT101Solution.MacayaFramework.Commands;
using MacayaIPT101Solution.MacayaFramework.Queries;
using MacayaIPT101Solution.MacayaYoutubeViewer.Stores;
using MacayaIPT101Solution.MacayaYoutubeViewer.ViewModels;
using MacayaIPT101Solution.MacayaYoutubeViewer.HostBuilders;
using Microsoft.EntityFrameworkCore;

namespace MacayaIPT101Solution.MacayaYoutubeViewer
{
    /// <summary>
